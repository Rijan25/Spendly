...
def seed_db():
    ...
    expenses = [
        ...
        (user_id, 15.00,  "Entertainment", "2026-06-09", "Movie ticket"),
        (user_id, 65.00,  "Shopping",      "2026-06-11", "Clothes"),
        (user_id, 8.00,   "Other",         "2026-06-13", "Miscellaneous"),
        (user_id, 22.00,  "Food",          "2026-06-14", "Groceries"),
    ]
    conn.executemany(
